        ...
        <div class="w-1/2 p-8">
            ...
            <form>
                <div class="mb-4">
                    ...
                    <input type="text" id="full-name" name="full-name" placeholder="Enter your full name" class="mt-1 block w-full border-2 border-yellow-400 p-2 rounded-full focus:ring-yellow-500 focus:border-yellow-500">
                </div>

                <div class="mb-4">
                    <label for="user-name" class="block text-sm font-medium text-gray-800">Username</label>
                    <input type="text" id="user-name" name="user-name" placeholder="Choose a username" class="mt-1 block w-full border-2 border-yellow-400 p-2 rounded-full focus:ring-yellow-500 focus:border-yellow-500">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="confirm-password" name="confirm-password" placeholder="Confirm your password" class="mt-1 block w-full border-2 border-yellow-400 p-2 rounded-full focus:ring-yellow-500 focus:border-yellow-500">
                </div>
